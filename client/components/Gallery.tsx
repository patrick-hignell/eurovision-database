  ...
  return (
    <div className="flex w-full justify-center">
      <div
        ...
        style={{ height: `${size * 5}rem` }}
      >
        <div className="flex w-[99%] min-w-0 justify-evenly gap-4 overflow-x-scroll rounded-sm bg-white bg-opacity-25 outline outline-1 outline-white">
          {entry.link != '' && (
